...
v0Correlation          = cms.EDAnalyzer('KslaCorrelation',
        ...
        bkgnum         = cms.int32(20),
        ptbin_n        = cms.int32(11),
        peakFactor     = cms.double(2.0),
        sideFactor     = cms.double(3.0),
        mis_ks_range   = cms.double(0.020),
        kis_la_range   = cms.double(0.010),
        mis_ph_range   = cms.double(0.015),
